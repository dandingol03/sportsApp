...
public class MyReceiver extends ReactContextBaseJavaModule {
    ...
    public MyReceiver(ReactApplicationContext reactContext) {
        super(reactContext);
    }
...
//                        intent = new Intent();
//                        intent.setClassName(context.getPackageName(), context.getPackageName() + ".TestActivity");
//                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                    } else {
