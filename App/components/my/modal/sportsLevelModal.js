...
class sportsLevelModal extends Component{
            ...
            <View style={styles.container}>
                ...
                <View style={{padding:10}}>
                    <View style={{flexDirection:'row',alignItems:'center',padding:4}}>
                        <Text style={{color:'#222',fontSize:17,fontWeight:'bold'}}>修改运动水平</Text>
                    </View>
                    <View style={{flexDirection:'column',alignItems:'center',padding:4,paddingTop:15,borderBottomWidth:1,borderColor:'#66CDAA'}}>
                        ...
                        <TouchableOpacity style={{padding:1,margin:2,flexDirection:'row',justifyContent:'center',alignItems:'center',
                            ...
                            onClick={()=>{
                                     ...
                                     this.addItem({state:"国家一级运动员",_id:0});
                                }}
                            isChecked={false}
                            leftText={null}
                            />

                            <Text style={{color:'#000',padding:5}}>国家一级运动员</Text>
                        </TouchableOpacity>:
                            <TouchableOpacity style={{padding:1,margin:2,flexDirection:'row',justifyContent:'center',alignItems:'center',
}}
                                                              onPress={()=>{ }}>
                            <CheckBox
                                ...
                                this.setState({datas:Object.assign(this.state.datas,{check0:false})})
                                   this.removeItem({state:"国家一级运动员",_id:0})
                                }}
                                isChecked={true}
                                leftText={null}
                            />
                        ...
                        <TouchableOpacity style={{padding:1,margin:2,flexDirection:'row',justifyContent:'center',alignItems:'center',
                            ...
                            <CheckBox
                                ...
                                onClick={()=>{
                                     ...
                                     this.addItem({state:"国家二级运动员",_id:1});
                            ...
                            <Text style={{color:'#000',padding:5}}>国家二级运动员</Text>
                        </TouchableOpacity>:
                            <TouchableOpacity style={{padding:1,margin:2,flexDirection:'row',justifyContent:'center',alignItems:'center',
}}
                                              onPress={()=>{ }}>
                                <CheckBox
                                   ...
                                   this.removeItem({state:"国家二级运动员",_id:1})
                        ...
                        <TouchableOpacity style={{padding:1,margin:2,flexDirection:'row',justifyContent:'center',alignItems:'center',
                            ...
                            <CheckBox
                                ...
                                onClick={()=>{
                                     ...
                                     this.addItem({state:"社会指导员",_id:2});
                            ...
                            <Text style={{color:'#000',padding:5}}>      社会指导员  </Text>
                        </TouchableOpacity>:
                            <TouchableOpacity style={{padding:1,margin:2,flexDirection:'row',justifyContent:'center',alignItems:'center',
}}
                                              onPress={()=>{ }}>
                                <CheckBox
                                   ...
                                   this.removeItem({state:"社会指导员",_id:2})
                        ...
                        <TouchableOpacity style={{padding:1,margin:2,flexDirection:'row',justifyContent:'center',alignItems:'center',
                            ...
                            <Text style={{color:'#000',padding:5}}>     体育本科       </Text>
                        </TouchableOpacity>:
                            <TouchableOpacity style={{padding:1,margin:2,flexDirection:'row',justifyContent:'center',alignItems:'center',
}}
                                              onPress={()=>{ }}>
                                <CheckBox
                                   ...
                                   this.removeItem({state:"体育本科",_id:3})
                        ...
                        <TouchableOpacity style={{padding:1,margin:2,flexDirection:'row',justifyContent:'center',alignItems:'center',
                            ...
                            <Text style={{color:'#000',padding:5}}>     体育硕士       </Text>
                        </TouchableOpacity>:
                            <TouchableOpacity style={{padding:1,margin:2,flexDirection:'row',justifyContent:'center',alignItems:'center',
}}
                                              onPress={()=>{ }}>
                                <CheckBox
                                  ...
                                  this.setState({datas:Object.assign(this.state.datas,{check4:false})})
                                   this.removeItem({state:"体育硕士",_id:4})
                        ...
                        <TouchableOpacity style={{padding:1,margin:2,flexDirection:'row',justifyContent:'center',alignItems:'center',
                            ...
                            <CheckBox
                                style={{padding: 2}}
                                onClick={()=>{
                                    this.setState({datas:Object.assign(this.state.datas,{check5:true})})
                                     this.addItem({state:"体育教师资格证",_id:5});
                            ...
                            <Text style={{color:'#000',padding:5}}>体育教师资格证</Text>
                        </TouchableOpacity>:
                                <TouchableOpacity style={{padding:1,margin:2,flexDirection:'row',justifyContent:'center',alignItems:'center',
}}
                                                  onPress={()=>{}}>
                                    <CheckBox
                                        style={{padding: 2}}
                                        onClick={()=>{
                                    this.setState({datas:Object.assign(this.state.datas,{check5:false})})
                                   this.removeItem({state:"体育教室资格证",_id:5})
...
module.exports = sportsLevelModal;
