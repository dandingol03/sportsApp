...
class HeightWeightModal extends Component{
            ...
            <View style={styles.container}>
                ...
                <View style={{padding:10}}>
                    <View style={{flexDirection:'row',alignItems:'center',padding:4}}>
                        <Text style={{color:'#222',fontSize:17,fontWeight:'bold'}}>修改身高体重</Text>
                    </View>
...
module.exports = HeightWeightModal;
